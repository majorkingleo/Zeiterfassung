                ...
                if( d2.equals(d1) )
                {
                    JOptionPane.showMessageDialog(null,
                    	StringUtils.autoLineBreak(
                            "Eintrag " + i+1 + " und Eintrag " + j+1 + "sind der selbe Tag."),
                            "Fehler",
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jLTitle, javax.swing.GroupLayout.DEFAULT_SIZE, 558, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
// TODO add your handling code here:
		...
		new AutoMBox(getTitle()) {
            ...
            private void insertOrUpdateValues(DBExtraHolidays entry) throws Exception {
