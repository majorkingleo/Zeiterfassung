                ...
                if (failed == true) {
                    JOptionPane.showMessageDialog(null,
                    	StringUtils.autoLineBreak(
                            "Eintrag " + counter1 + " und Eintrag " + counter2 + 
                            " überschneiden sich!"),
                            "Fehler",
        ...
        new AutoMBox("UserPerMonth", autombox) {
            ...
            public void do_stuff() throws Exception {
                ...
                values = trans.fetchTable(
                        new DBUserPerMonth( new UserQuery( getTransaction() ) ));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jLTitle, javax.swing.GroupLayout.DEFAULT_SIZE, 788, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void newEntry( boolean autombox ) {
        new AutoMBox( "UserPerMonth", autombox ) {
            ...
            public void do_stuff() throws Exception {
                ...
                upm.usage.loadFromString(root.getSetup().getConfig(AppConfigDefinitions.NormalWorkPercent));
                upm.hours_per_week.loadFromString(root.getSetup().getConfig(AppConfigDefinitions.HoursPerWeek));
                upm.hist.setAnHist(root.getUserName());
                upm.days_per_week.loadFromString(root.getSetup().getConfig(AppConfigDefinitions.DaysPerWeek));
