...
public class WizardStepLogin extends WizardBaseWindow implements WizardWindowInterface {
    ...
    public void onInit() {
        ...
        {
            //parentWizard.applyAction(WizardAction.WIZARD_ACTION_PREV, rootPaneCheckingEnabled);
            setRecentAction(WizardAction.WIZARD_ACTION_NEXT);
            parentWizard.handleUpdate();
        }
    }
